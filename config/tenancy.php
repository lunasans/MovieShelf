...
return [
    ...
    'id_generator' => null, // We use the subdomain as the tenant ID
    ...
    'bootstrappers' => [
        ...
        \App\Tenancy\S3TenancyBootstrapper::class,
    ...
    'database' => [
         ...
         */
        'managers' => [
            'sqlite' => \App\Tenancy\TenantSQLiteManager::class,
            'tenant' => \App\Tenancy\TenantSQLiteManager::class, // Backup for template connection name
