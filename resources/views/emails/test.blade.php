    ...
    <table role="presentation" width="100%" style="border-collapse: collapse; border: 0;">
        ...
        <tr>
            <td style="padding-bottom:28px; text-align: center;">
                <table role="presentation" style="border-collapse: collapse; border: 0; margin-left: auto; margin-right: auto;">
                    <tr>
        ...
        <tr>
            <td style="padding-bottom:28px;">
                <table role="presentation" width="100%" style="background-color:#ffffff;border:1px solid #e5e7eb;border-radius:12px; border-collapse: collapse;">
                    <tr>
