                            ...
                            <tr class="group hover:bg-white/[0.02] transition-colors">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end gap-2">
                                        <button @click="openEditModal({{ $user->toJson() }})" class="p-2 text-white/20 hover:text-white transition-colors" title="Bearbeiten">
                ...
                <div class="glass relative w-full max-w-md p-8 rounded-[2.5rem] border-white/10 shadow-2xl">
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all @error('name') border-rose-500/50 ring-2 ring-rose-500/20 @enderror">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all @error('email') border-rose-500/50 ring-2 ring-rose-500/20 @enderror">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all @error('password') border-rose-500/50 ring-2 ring-rose-500/20 @enderror">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center p-6">
                ...
                <div class="glass relative w-full max-w-md p-8 rounded-[2.5rem] border-white/10 shadow-2xl">
                    ...
                    <form :action="'{{ url('admin/users') }}/' + editingUser.id" method="POST" class="space-y-4">
                        ...
                        <div>
                            <label class="block text-[10px] font-black text-white/40 uppercase tracking-widest mb-2 px-1">Name</label>
                            <input type="text" name="name" :value="editingUser.name" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all @error('name') border-rose-500/50 ring-2 ring-rose-500/20 @enderror">
                            @error('name') <p class="text-rose-400 text-[10px] mt-2 ml-1 font-bold">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-white/40 uppercase tracking-widest mb-2 px-1">E-Mail</label>
                            <input type="email" name="email" :value="editingUser.email" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all @error('email') border-rose-500/50 ring-2 ring-rose-500/20 @enderror">
                            @error('email') <p class="text-rose-400 text-[10px] mt-2 ml-1 font-bold">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-white/40 uppercase tracking-widest mb-2 px-1">Neues Passwort (optional)</label>
                            <input type="password" name="password" class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all @error('password') border-rose-500/50 ring-2 ring-rose-500/20 @enderror" placeholder="Leer lassen zum Beibehalten">
                            @error('password') <p class="text-rose-400 text-[10px] mt-2 ml-1 font-bold">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-white/40 uppercase tracking-widest mb-2 px-1">Bestätigen</label>
