...
<div class="card glass" x-data="faqForm()">
    <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 3rem;">
            ...
            <div>
                ...
                <div style="padding-top: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">
                    ...
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $faq->is_active) ? 'checked' : '' }} style="width: 1.2rem; height: 1.2rem; cursor: pointer; accent-color: var(--primary);">
        ...
        <div style="text-align: right;">
            <button type="submit" class="btn">FAQ aktualisieren</button>
        </div>
    </form>
</div>
