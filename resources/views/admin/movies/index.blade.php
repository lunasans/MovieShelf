    ...
    <div class="space-y-8" x-data="{
        ...
        <div class="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
            <div class="flex items-center gap-4 flex-wrap">
                <a href="{{ route('admin.tmdb.index') }}" class="px-8 py-3.5 bg-rose-600 hover:bg-rose-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl shadow-rose-500/20 flex items-center gap-3 group">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 w-full xl:w-auto">
                ...
                @if(request('filter') === 'locked')
                    <a href="{{ route('admin.movies.index') }}" class="px-4 py-2 bg-white/5 text-white/60 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2">
                        <i class="bi bi-arrow-left"></i>
                        Zu den aktiven Filmen
                    </a>
                @else
                    <a href="{{ route('admin.movies.index', ['filter' => 'locked']) }}" class="px-4 py-2 bg-white/5 text-white/60 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2">
            ...
            <div class="p-6 bg-amber-500/5 border border-amber-500/10 rounded-3xl flex items-center gap-4 text-amber-400/80">
                ...
                <span class="text-xs font-black uppercase tracking-widest">
                    ...
                    <span class="text-white">{{ [
                        'missing_tmdb'    => 'Fehlende TMDb-Verknüpfung',
                        'missing_cover'   => 'Fehlende Cover',
                        'missing_trailer' => 'Fehlende Trailer',
                        'locked'          => 'Nur gesperrte Filme',
                    ][request('filter')] ?? request('filter') }}</span>
                </span>
            </div>
        @endif
