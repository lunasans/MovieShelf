...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
    data-theme="{{ session('theme', \App\Models\Setting::get('theme', 'default')) }}" style="background-color: #0c0c0e;">
...
<head>
    ...
    <link
        ...
        rel="stylesheet"> <!-- NOSONAR -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"
        integrity="sha256-9kPW/n5nn53j4WMRYAxe9c1rCY96Oogo/MKSVdKzPmI=" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.2/dist/chart.umd.js"
        integrity="sha256-x+LL+wNI+ZAd7MSX8xbB/qhCAgm2EEEv+4j9PVFvnTA=" crossorigin="anonymous"></script> <!-- Scripts --> @vite(['resources/css/app.css', 'resources/js/app.js']) <style>
        [x-cloak] {
...
<body class="font-sans antialiased text-white min-h-screen relative"
    ...
    <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none" x-show="bg1 || bg2"
        ...
        <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out"
            ...
            :style="'background-image: url(' + bg1 + '); background-size: cover; background-position: center;'"> </div>
        <!-- Layer 2 -->
        <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out"
