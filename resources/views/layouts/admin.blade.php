...
<body class="font-sans antialiased bg-[#020617] text-gray-200" x-data="{ sidebarOpen: false }">
    <div class="min-h-screen flex bg-[#020617]">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
            class="fixed lg:sticky top-0 left-0 w-64 admin-sidebar border-r border-white/5 flex flex-col z-50 shrink-0 h-screen transition-transform duration-300 ease-in-out">
