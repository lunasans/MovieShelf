...
<div class="{{ $layoutMode === 'streaming' ? 'streaming-stats-view min-h-screen pt-4 pb-20 px-12 md:px-20 relative' : 'space-y-8 p-8 max-w-[90rem] mx-auto overflow-y-auto no-scrollbar h-full' }}">
