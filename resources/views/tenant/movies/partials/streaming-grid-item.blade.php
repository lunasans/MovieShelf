<div @click="window.location.href = '{{ route('movies.show', $movie) }}'" 
     class="aspect-[2/3] relative rounded-[2rem] overflow-hidden glass-streaming border border-white/10 group cursor-pointer hover:border-rose-500/50 hover:scale-105 transition-all duration-500 shadow-2xl">
    @if($movie->cover_url)
