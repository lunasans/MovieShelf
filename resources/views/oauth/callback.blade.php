...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-sm text-center">
        ...
        @php($denied = ($denied ?? false))
        <div class="bg-gray-900 border border-gray-800 rounded-2xl p-8">
            @if($denied)
                <div class="w-16 h-16 bg-gray-400/10 border border-gray-400/30 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <span class="text-2xl text-gray-400">×</span>
                </div>
                <h1 class="text-lg font-semibold mb-2">Zugriff abgelehnt</h1>
            @else
